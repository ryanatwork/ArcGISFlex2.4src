    ...
    private function configService_resultHandler(event:ResultEvent):void
    {
        try
        {
            ...
            if (arcGISWebMapItemID)
            {
                ...
                {
                    AppEvent.showError(error.faultString);
                }
            }
            else
            {
        ...
        {
            AppEvent.showError(StringUtil.substitute(getDefaultString("parseConfigErrorText"), error.message));
        }
    }
